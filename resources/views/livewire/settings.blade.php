        ...
        <div class="flex flex-col items-center justify-center bg-white pt-2">
            <div class="w-full">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ Auth::user()->role == 'service_provider' ? route('profile.setup') : route('profile.show')}}" wire:navigate.hover class="flex items-center justify-between w-full px-4 py-4 text-lg font-semibold text-black">
                        Account
